...
<div class="content pb-2">
    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8 d-flex flex-row align-items-center justify-content-end">
                                <div class="form-group m-0">
                                    <a href="" class="btn btn-primary" style="width:120px;" id="btnFiltrar">Buscar</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row mb-3">
            <div class="col-md-12">
                <h4>Total venta: S./ <span id="totalVenta"></span></h4>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
            ...
            drawCallback: function(settings) {
                ...
                api.column(groupColumn, {
                    ...
                    if (last !== group) {
                        ...
                        $(rows).eq(i).before(
                            '<tr class="group">' +
                            '<td colspan="6" class="fs-6 fw-bold fst-italic bg-cyan text-white"> ' +
                            '<i nroBoleta = ' + nroBoleta + ' class="fas fa-trash fs-6 text-ligth mx-2 btnEliminarVenta" style="cursor:pointer;"></i> ' +
                            group +
                            '</td>' +
                            '</tr>'
                        );
