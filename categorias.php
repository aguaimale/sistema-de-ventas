...
<div class="content pb-2">
    <div class="row p-0 m-0">
        ...
        <div class="col-md-8">
            <div class="card card-outline shadow">
                <div class="card-header">
                    <h3 class="card-title text-light"><i class="fas fa-list"></i> Listado de Categorias</h3>
                </div>
                <div class="card-body">
        ...
        <div class="col-md-4">
            <div class="card  card-outline shadow">
                <div class="card-header">
                    <h3 class="card-title text-light"><i class="fas fa-edit"></i> Registro de Categorías</h3>
                </div>
                <div class="card-body">
